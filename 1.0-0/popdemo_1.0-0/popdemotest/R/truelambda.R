...
#' a single element equal to 1, e.g. for a matrix of dimension 3, the set of 
#' stage-biased vectors are: \code{c(1,0,0)}, \code{c(0,1,0)} and 
#' \code{c(0,0,1)}. This is useful for understanding ergodicity of the model: an 
#' ergodic model has the same true lambda for every stage-biased projection and 
#' this is equal to the dominant eigenvalue of \code{A}. A non-ergodic model
#' will have at least one stage-biased projection that has a different true lambda
#' to the others in the set, which is not equal to the dominant eigenvalue of 
#' \code{A}.\cr\cr
#'
#' @return 
...
#' \cr\cr
#'
#' @family measures of convergence
#'
#' @examples
