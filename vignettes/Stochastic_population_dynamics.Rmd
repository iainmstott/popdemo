...
#urlcolor: "cyan"
vignette: >
  %\VignetteIndexEntry{Stochastic population dynamics}
...
```{r echo = FALSE}
knitr::include_graphics("_Pbear.jpg")
```
...
```
[^2]: [L�fgren et al. (2000) Ann. Bot. Fennici, 37, 183-192.](http://www.sekj.org/PDF/anbf37/anbf37-183p.pdf)
