...
#' NOTE that \code{N} is not indicative of minimum possible population size for a 
...
#' (Townley & Hodgson 2008; Stott \emph{et al}. 2011).\cr\cr
...
#' \code{maxatt} will not work for imprimitive or reducible matrices: in these cases,
#' a maximum attenuation often cannot be defined.\cr\cr
#'
#' @return 
