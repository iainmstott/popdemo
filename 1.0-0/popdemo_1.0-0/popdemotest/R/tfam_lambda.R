...
#' \code{\link{plot.tfam_lambda}} to visualise how perturbations affect the 
...
#' \code{tfam_lambda} will not work for reducible matrices.\cr\cr
#'
#' @return 
...
#' the lambda values for the transfer function of element [3,2] of the matrix.\cr\cr
#'
#' @references
#' \href{http://onlinelibrary.wiley.com/doi/10.1111/j.0021-8901.2004.00959.x/full}{
#' Townley & Hodgson (2004) J. Appl. Ecol., 41, 1155-1161.}\cr
#' \href{http://www.sciencedirect.com/science/article/pii/S0040580906000335}{
#' Hodgson \emph{et al}. (2006) Theor. Popul. Biol., 70, 214-224.}\cr\cr
#'
