...
#' 
#' @concept 
#' transfer function systems control resolvent inertia population momentum
#' stable equivalent ratio perturbation nonlinear viability analysis PVA
#' demography
#'
plot.tfa <-
