...
#'
#' @seealso
#' S3 plotting method: \code{\link{plot.tfa}}\cr\cr
#'
#' @examples
#'   # Create a 3x3 matrix
...
#' 
#' @concept 
#' transfer function systems control perturbation nonlinear resolvent transient 
#' dynamics stable equivalent ratio momentum amplification attenuation population
#' viability PVA ecology demography
#'
#' @export
#'
tfa_inertia <-
