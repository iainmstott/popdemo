...
#' \code{e = matrix(c(0,0.5,1), ncol=1)}. 
#' Currently \code{tfs_inertia} can only work with rank-one, single-parameter 
...
#' 
#' @concept 
#' transfer function systems control resolvent demography 
