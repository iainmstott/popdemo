...
#' population size and asymoptotic growth (Townley & Hodgson 2008; Stott 
#' \emph{et al}. 2011).\cr\cr
...
#' (transient dynamics in the first timestep).\cr\cr
#'
#' @return 
...
#' \code{A} if \code{bound="lower"}. If \code{vector} is specified, the 
#' 'case-specific' reactivity or first-timestep attenuation of the model.\cr\cr
...
#' \href{http://onlinelibrary.wiley.com/doi/10.1111/j.1365-2664.2008.01562.x/full}{
