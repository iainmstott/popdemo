...
#' (therefore potentially nonergodic) models.\cr\cr
#'
#' @return 
...
order<-dim(A)[1]
if(!isIrreducible(A)) stop("Matrix is reducible: the projection may not converge!")
if(!isPrimitive(A)) stop("Matrix is imprimitive: the projection may not converge!")
