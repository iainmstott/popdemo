...
#' (see details).
#'
#' @param lambdarange a numeric vector giving the target range of lambda values 
...
#'
#' @seealso
#' S3 plotting method: \code{\link{plot.tfa_lambda}}\cr\cr
#'
#' @examples
#'   # Create a 3x3 matrix
...
#' PVA ecology demography resolvent 
#'
#' @export
#'
tfa_lambda <-
