...
#'
#' @description
#' Calculate the elasticity matrix for a opulation matrix projection model,
#' using eigenvectors.
#'
...
#' subdominant eigenvalues.\cr\cr
#'
#' @return 
#' A numeric (real or complex) matrix of equal dimension to \code{A}.\cr\cr
#'
#' @references
#' Caswell (2001) Matrix Population Models 2nd ed. Sinauer.\cr\cr
#'
