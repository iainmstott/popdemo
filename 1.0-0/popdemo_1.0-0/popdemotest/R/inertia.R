...
#'
#' @param t (optional) the time in the projection at which \code{N} is to be 
...
#' \code{inertia} will not work with imprimitive or reducible matrices.\cr\cr
#'
#' @return 
#' If \code{vector="n"}, the upper bound on inertia of \code{A} if 
#' \code{bound="upper"} and the lower bound on inertia of \code{A} if 
#' \code{bound="lower"}. If \code{vector} is specified, the case-specific 
#' inertia of the model.\cr\cr
#' If \code{return.N=TRUE} and \code{t} is specified, a list with components:
#' \item{inertia}{the bound on or case-specific inertia, as above.}
#' \item{N}{the population size at specified \code{t}.}
#'
#' @references
#' href{http://onlinelibrary.wiley.com/doi/10.1890/06-1801.1/abstract}{
#' Koons \emph{et al}. (2007) Ecology, 88, 2867-2867.}\cr
#' \href{http://onlinelibrary.wiley.com/doi/10.1111/j.1461-0248.2011.01659.x/full}{
#' Stott \emph{et al}. (2011) Ecol. Lett., 14, 959-970.}\cr\cr
#'
#' @family transient indices
#'
#' @seealso
#' Transfer function methods for inertia: \code{\link{tfa_inertia}}, 
#' \code{\link{tfam_inertia}}, \code{\link{tfs_inertia}}, 
#' \code{\link{tfsm_inertia}}
#'
#' @examples
#'   # Create a 3x3 PPM
