...
#'
#' Matrix Projection Model of class \code{matrix} for the desert tortoise 
#' \emph{Gopherus agassizii} with medium fecundity. The matrix is based on a 
#' population in the Western Mojave desert. Stages are based on age and size 
