...
#' to stability or stationarity, and diagnostic and manipulation tools.\cr\cr
...
#' \code{\link{Projection-plots}}\cr\cr
#' Asymptotic population dynamics:\cr
...
#' and \code{\link{tfsm_inertia}} functions.\cr
