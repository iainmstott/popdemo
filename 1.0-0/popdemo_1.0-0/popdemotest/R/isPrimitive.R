...
#' of \strong{A} (Caswell 2001).\cr\cr
#'
#' @return 
#' \code{TRUE} (for a primitive matrix) or \code{FALSE} (for an imprimitive 
#' matrix).\cr\cr
#'
#' @references
...
#'
#' @concept
#' primitivity primitive imprimitive Perron Frobenius weak strong ergodic
#'
#' @export
#' @importFrom expm "%^%"
#'
